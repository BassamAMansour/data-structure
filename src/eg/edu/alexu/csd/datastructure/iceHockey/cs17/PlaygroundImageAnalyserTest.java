...
public class PlaygroundImageAnalyserTest {
    @Test
    public void findPlayers0() {
        IPlayersFinder iPlayersFinder = new PlaygroundImageAnalyser();
        Point[] pointsArray = iPlayersFinder.findPlayers(new String[]{
                "33JUBU33",
                "3U3O4433",
                "O33P44NB",
                "PO3NSDP3",
        ...
        for (int i = 0; i < pointsArray.length; i++) {
            string.append("java.awt.Point[x=" + (int) pointsArray[i].getX() + ",y=" + (int) pointsArray[i].getY() + "]" + "\n");
        }
    ...
    public void findPlayers1() {
        IPlayersFinder iPlayersFinder = new PlaygroundImageAnalyser();
        Point[] pointsArray = iPlayersFinder.findPlayers(new String[]{"44444H44S4",
                "K444K4L444",
                "4LJ44T44XH",
                "444O4VIF44",
                "44C4D4U444",
    ...
    public void findPlayers2() {
        ...
        Assert.assertTrue("wrong", ("java.awt.Point[x=1,y=17]\n" +
